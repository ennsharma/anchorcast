...
T2V_MODEL = "minimax/h3-max/text-to-video"
...
class H3Max:
    def __init__(
        self,
        *,
        model_id: str = I2V_MODEL,
        text_model_id: str = T2V_MODEL,
    ...
    def generate(self, request: GenerateRequest) -> Segment:
        ...
        if request.image_path is None:
            ...
            arguments["image_url"] = fal_client.upload_file(str(request.image_path))
